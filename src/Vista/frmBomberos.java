...
txtPeso.addFocusListener(new java.awt.event.FocusAdapter() {
    ...
    public Image getIconImage() {
     ...
     // Limpia el campo de Nombre cuando se enfoca
...
// Restaura el hint de Nombre cuando se pierde el foco
...
// Limpia el campo de Correo cuando se enfoca
...
// Restaura el hint de Correo cuando se pierde el foco
...
// Limpia el campo de Edad cuando se enfoca
...
// Restaura el hint de Edad cuando se pierde el foco
private void txtEdadFocusLost(java.awt.event.FocusEvent evt) {
...
// Limpia el campo de Peso cuando se enfoca
private void txtPesoFocusGained(java.awt.event.FocusEvent evt) {
    if (txtPeso.getText().equals("Peso")) {
        txtPeso.setText("");
        txtPeso.setForeground(Color.black);
    }
}

// Restaura el hint de Peso cuando se pierde el foco
private void txtPesoFocusLost(java.awt.event.FocusEvent evt) {
    ...
    private void initComponents() {
        ...
        jScrollPane3.setViewportView(jtbBomberos);
